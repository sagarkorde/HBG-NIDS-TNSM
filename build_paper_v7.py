"""
Build IEEE_TNSM_Paper_Improved_v7.docx  —  Final version with GitHub repository URL added.
Changes from v5:
...
OUT  = os.path.join(BASE, "IEEE_TNSM_Paper_Final.docx")
GITHUB_URL = "https://github.com/sagarkorde/HBG-NIDS-TNSM"
...
para(doc,
     ...
     f"Code and supplementary material publicly available at: {GITHUB_URL}")
...
para(doc,
     "All experimental code, LaTeX source, BibTeX references, and supplementary "
     "material (weight grid search results, IF tuning logs, SHAP outputs, graph "
     "visualisations) are publicly available at:")
p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
p.paragraph_format.space_before = Pt(2); p.paragraph_format.space_after = Pt(6)
r = p.add_run(GITHUB_URL)
r.bold = True; r.font.size = Pt(10); r.font.name = "Courier New"
r.font.color.rgb = RGBColor(0x17, 0x4A, 0xE4)
divider(doc)
